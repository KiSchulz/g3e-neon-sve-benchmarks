...
benchmark_driver/benchmark_driver -dev --benchmark_format=json --benchmark_out="$filename" --benchmark_context=CPU="$cpu" --benchmark_repetitions=5 --benchmark_report_aggregates_only=true --benchmark_time_unit=ns
